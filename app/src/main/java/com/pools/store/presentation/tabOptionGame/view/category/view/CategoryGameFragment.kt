package com.pools.store.presentation.tabOptionGame.view.category.view
...
import com.pools.store.databinding.FragmentCategoryGameBinding
...
@AndroidEntryPoint
class CategoryGameFragment : BaseFragment<FragmentCategoryGameBinding, CategoryViewModel>() {

    override fun getViewBinding() = FragmentCategoryGameBinding.inflate(layoutInflater)
    ...
    private fun initPaging() {
        viewModel.getListCategory(Constant.GAME)
        lifecycleScope.launch {
            with(viewModel) {
                ...
                categoryPagingAdapter.loadStateFlow.distinctUntilChangedBy { it.refresh }
                    ...
                    .collect { binding.rvCategoryGame.scrollToPosition(0) }
            }
