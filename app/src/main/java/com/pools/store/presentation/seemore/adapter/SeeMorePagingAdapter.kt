package com.pools.store.presentation.seemore.adapter
...
class SeeMorePagingAdapter @Inject constructor() :
    ...
    inner class ItemViewHolder(private val binding: ItemAppStoreBinding) :
...
//                Glide.with(binding.ivApp.context).load(item.iconUrl).into(ivApp)
